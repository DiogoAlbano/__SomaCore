        ...
        internal void OnAssetRequested_ConfigDinamicInteriorsTilesheets(object sender, AssetRequestedEventArgs e)
        {
            if (e.NameWithoutLocale.IsEquivalentTo("Maps/_sc_dinamic_interiors"))
            {
                e.Edit(asset =>
                {
                    ...
                    editor.PatchImage(source, sourceArea: new Rectangle(400, 1152, 32, 32), targetArea: new Rectangle(144, 628, 32, 32), patchMode: PatchMode.Replace);
                    ...
                    editor.PatchImage(source, sourceArea: new Rectangle(157, 563, 7, 11), targetArea: new Rectangle(36, 966, 7, 11), patchMode: PatchMode.Replace);
                    ...
                    editor.PatchImage(source, sourceArea: new Rectangle(320, 640, 64, 32), targetArea: new Rectangle(224, 1152, 64, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(448, 720, 48, 48), targetArea: new Rectangle(224, 1200, 48, 48), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(448, 1184, 16, 48), targetArea: new Rectangle(272, 1200, 16, 48), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(352, 1152, 48, 48), targetArea: new Rectangle(224, 1264, 48, 48), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(128, 1312, 16, 48), targetArea: new Rectangle(272, 1264, 16, 48), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(256, 832, 32, 32), targetArea: new Rectangle(224, 1328, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(384, 640, 32, 32), targetArea: new Rectangle(256, 1328, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(416, 640, 16, 32), targetArea: new Rectangle(224, 1376, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(448, 640, 32, 32), targetArea: new Rectangle(240, 1376, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(416, 698, 16, 18), targetArea: new Rectangle(272, 1382, 16, 18), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(320, 672, 32, 16), targetArea: new Rectangle(256, 1424, 32, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(352, 672, 32, 16), targetArea: new Rectangle(256, 1440, 32, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(384, 672, 32, 16), targetArea: new Rectangle(256, 1456, 32, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(368, 976, 16, 41), targetArea: new Rectangle(272, 1494, 16, 41), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(464, 1312, 16, 41), targetArea: new Rectangle(256, 1558, 16, 41), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 1312, 16, 41), targetArea: new Rectangle(272, 1558, 16, 41), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(16, 1312, 32, 42), targetArea: new Rectangle(256, 1622, 32, 42), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(480, 1392, 16, 16), targetArea: new Rectangle(256, 1680, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 880, 16, 16), targetArea: new Rectangle(272, 1680, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(16, 880, 32, 16), targetArea: new Rectangle(256, 1696, 32, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(48, 880, 32, 16), targetArea: new Rectangle(256, 1712, 32, 16), patchMode: PatchMode.Replace);
                    source = ModEntry.ModHelper.GameContent.Load<Texture2D>("TileSheets/Craftables");
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 32, 32, 32), targetArea: new Rectangle(256, 1744, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 32, 48, 32), targetArea: new Rectangle(240, 1792, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 32, 16, 32), targetArea: new Rectangle(256, 1840, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 32, 16, 32), targetArea: new Rectangle(272, 1840, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 64, 64, 32), targetArea: new Rectangle(224, 1888, 64, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(64, 64, 32, 32), targetArea: new Rectangle(224, 1936, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 96, 32, 32), targetArea: new Rectangle(256, 1936, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 96, 32, 32), targetArea: new Rectangle(256, 1984, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 96, 16, 32), targetArea: new Rectangle(240, 2032, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 128, 32, 32), targetArea: new Rectangle(256, 2032, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 128, 48, 32), targetArea: new Rectangle(240, 2080, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 128, 48, 32), targetArea: new Rectangle(240, 2128, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 160, 64, 32), targetArea: new Rectangle(224, 2176, 64, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(64, 160, 64, 32), targetArea: new Rectangle(208, 2224, 64, 32), patchMode: PatchMode.Replace);
                    if (Game1.currentSeason.Equals("spring"))
                    {
                        editor.PatchImage(source, sourceArea: new Rectangle(0, 192, 16, 32), targetArea: new Rectangle(272, 2224, 16, 32), patchMode: PatchMode.Replace);
                    }
                    else if (Game1.currentSeason.Equals("summer"))
                    {
                        editor.PatchImage(source, sourceArea: new Rectangle(16, 192, 16, 32), targetArea: new Rectangle(272, 2224, 16, 32), patchMode: PatchMode.Replace);
                    }
                    else if (Game1.currentSeason.Equals("fall"))
                    {
                        editor.PatchImage(source, sourceArea: new Rectangle(32, 192, 16, 32), targetArea: new Rectangle(272, 2224, 16, 32), patchMode: PatchMode.Replace);
                    }
                    else if (Game1.currentSeason.Equals("winter"))
                    {
                        editor.PatchImage(source, sourceArea: new Rectangle(48, 192, 16, 32), targetArea: new Rectangle(272, 2224, 16, 32), patchMode: PatchMode.Replace);
                    }
                    editor.PatchImage(source, sourceArea: new Rectangle(64, 192, 64, 32), targetArea: new Rectangle(208, 2272, 64, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(96, 224, 16, 32), targetArea: new Rectangle(272, 2272, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 224, 16, 32), targetArea: new Rectangle(240, 2320, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 256, 32, 32), targetArea: new Rectangle(256, 2320, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 256, 32, 32), targetArea: new Rectangle(256, 2368, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(64, 256, 48, 32), targetArea: new Rectangle(240, 2416, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 256, 16, 32), targetArea: new Rectangle(240, 2464, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 288, 32, 32), targetArea: new Rectangle(256, 2464, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 288, 16, 32), targetArea: new Rectangle(272, 2512, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(48, 288, 16, 32), targetArea: new Rectangle(272, 2560, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(64, 288, 64, 32), targetArea: new Rectangle(224, 2608, 64, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(48, 320, 32, 32), targetArea: new Rectangle(256, 2656, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 352, 16, 32), targetArea: new Rectangle(256, 2704, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 352, 16, 32), targetArea: new Rectangle(272, 2704, 16, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(16, 384, 32, 32), targetArea: new Rectangle(256, 2752, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(48, 384, 32, 32), targetArea: new Rectangle(256, 2800, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 384, 48, 32), targetArea: new Rectangle(240, 3072, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 416, 48, 32), targetArea: new Rectangle(240, 3120, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(48, 416, 48, 32), targetArea: new Rectangle(240, 3168, 48, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(96, 416, 32, 32), targetArea: new Rectangle(160, 3216, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(16, 448, 32, 32), targetArea: new Rectangle(192, 3216, 32, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(64, 448, 64, 32), targetArea: new Rectangle(224, 3216, 64, 32), patchMode: PatchMode.Replace);
                    ...
                    //weapons
                    source = ModEntry.ModHelper.GameContent.Load<Texture2D>("TileSheets/weapons");
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 0, 128, 144), targetArea: new Rectangle(0, 2928, 128, 144), patchMode: PatchMode.Replace);
                    //tools
                    source = ModEntry.ModHelper.GameContent.Load<Texture2D>("TileSheets/tools");
                    editor.PatchImage(source, sourceArea: new Rectangle(96, 0, 160, 16), targetArea: new Rectangle(128, 2928, 160, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 32, 16, 16), targetArea: new Rectangle(128, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(192, 32, 16, 16), targetArea: new Rectangle(144, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(304, 32, 16, 16), targetArea: new Rectangle(160, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 64, 16, 16), targetArea: new Rectangle(176, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(192, 64, 16, 16), targetArea: new Rectangle(192, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 96, 16, 16), targetArea: new Rectangle(208, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(192, 96, 16, 16), targetArea: new Rectangle(224, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(304, 96, 16, 16), targetArea: new Rectangle(240, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 128, 16, 16), targetArea: new Rectangle(256, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(192, 128, 16, 16), targetArea: new Rectangle(272, 2944, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 160, 16, 16), targetArea: new Rectangle(128, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(192, 160, 16, 16), targetArea: new Rectangle(144, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(304, 160, 16, 16), targetArea: new Rectangle(160, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(80, 192, 16, 16), targetArea: new Rectangle(176, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(192, 192, 16, 16), targetArea: new Rectangle(192, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 224, 16, 16), targetArea: new Rectangle(208, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(144, 224, 16, 16), targetArea: new Rectangle(224, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(256, 224, 16, 16), targetArea: new Rectangle(240, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(32, 256, 16, 16), targetArea: new Rectangle(256, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(144, 256, 16, 16), targetArea: new Rectangle(272, 2960, 16, 16), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 16, 80, 32), targetArea: new Rectangle(128, 2976, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 16, 80, 32), targetArea: new Rectangle(204, 2976, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(224, 16, 80, 32), targetArea: new Rectangle(128, 3008, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 48, 80, 32), targetArea: new Rectangle(204, 3008, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 48, 80, 32), targetArea: new Rectangle(128, 3040, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 80, 80, 32), targetArea: new Rectangle(204, 3040, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 80, 80, 32), targetArea: new Rectangle(0, 3072, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(224, 80, 80, 32), targetArea: new Rectangle(80, 3072, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 112, 80, 32), targetArea: new Rectangle(160, 3072, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 112, 80, 32), targetArea: new Rectangle(0, 3104, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 144, 80, 32), targetArea: new Rectangle(80, 3104, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 144, 80, 32), targetArea: new Rectangle(160, 3104, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(224, 144, 80, 32), targetArea: new Rectangle(0, 3136, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 176, 80, 32), targetArea: new Rectangle(80, 3136, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 176, 80, 32), targetArea: new Rectangle(160, 3136, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 208, 80, 32), targetArea: new Rectangle(0, 3168, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 208, 80, 32), targetArea: new Rectangle(80, 3168, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(224, 208, 80, 32), targetArea: new Rectangle(160, 3168, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(0, 240, 80, 32), targetArea: new Rectangle(0, 3200, 80, 32), patchMode: PatchMode.Replace);
                    editor.PatchImage(source, sourceArea: new Rectangle(112, 240, 80, 32), targetArea: new Rectangle(80, 3200, 80, 32), patchMode: PatchMode.Replace);
