...
namespace __SomaCore.Managers
{
    ...
    {
        public bool OriginalWallpapers { get; set; } = false;
        public bool OriginalFloors { get; set; } = false;
        public bool OriginalPaitings { get; set; } = false;

    }
    public class SetGMCMMenu
    {
        internal void OnGameLaunched_InicializeGMCM(object sender, GameLaunchedEventArgs e)
        {
            ...
            configMenu.AddPageLink(
                mod: ModEntry.Manifest,
                pageId: "TilesheetsPage",
                text: () => ModEntry.ModHelper.Translation.Get("GMCM_TileSheetPage_Title"),
                tooltip: () => ModEntry.ModHelper.Translation.Get("GMCM_TileSheetPage_Description")
                );
            configMenu.AddPage(
               mod: ModEntry.Manifest,
               pageId: "TilesheetsPage",
               pageTitle: () => ModEntry.ModHelper.Translation.Get("GMCM_TileSheetPage_Title")
               );
            ...
            configMenu.AddParagraph(
                 mod: ModEntry.Manifest,
                 text: () => ModEntry.ModHelper.Translation.Get("GMCM_TileSheetPage_Paragraph_Warning")
                 );
            configMenu.AddBoolOption(
                mod: ModEntry.Manifest,
                name: () => ModEntry.ModHelper.Translation.Get("GMCM_TileSheetPage_OptionName_OriginalWallpaper"),
                tooltip: () => ModEntry.ModHelper.Translation.Get("GMCM_TileSheetPage_OptionDescription_OriginalWallpaper"),
                getValue: () => ModEntry.Config.OriginalWallpapers,
                setValue: value => ModEntry.Config.OriginalWallpapers = value
                );
        }
    }
}